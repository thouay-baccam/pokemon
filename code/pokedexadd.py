...
class PokedexAdd:
    def __init__(self):
        ...
        self.add_image_text = self.text_font.render("Ajouter une Image", True, (0, 0, 0))
        ...
        self.add_image_button_rect = pygame.Rect(add_image_text_x, add_image_text_y, add_image_text_rect.width, add_image_text_rect.height)
        ...
        self.save_button_rect = pygame.Rect(save_button_text_x, save_button_text_y, save_button_text_rect.width, save_button_text_rect.height)
